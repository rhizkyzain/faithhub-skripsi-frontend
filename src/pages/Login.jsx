...
const Login = () => {
  ...
  return (
    <div className="h-screen w-screen bg-blue-500 dark:bg-[#32353F]">
      <Toaster />
      <div className="flex flex-col items-center min-h-screen pt-6 sm:justify-center sm:pt-0">
        ...
        <div className="w-[90%] md:w-full bg-gray-300 dark:bg-[#1E212A] border px-6 py-4 mt-6 overflow-hidden shadow-md sm:max-w-md rounded-lg">
